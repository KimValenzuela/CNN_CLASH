...
def inceptionv2(image_size=80):
    ...
    x = tf.keras.layers.Conv2D(filters=64, kernel_size=(7,7), activation='relu')(inp)#, kernel_initializer=initializer)(inp) # (74, 74, 64)
    ...
    tower_5 = tf.keras.layers.concatenate([tower_1, tower_2, tower_3, tower_4], axis=1) # (16, 16, 240)
    ...
    tower_10 = tf.keras.layers.concatenate([tower_6, tower_7, tower_8, tower_9], axis=1) # (16, 16, 480)
    ...
    tower_31 = tf.keras.layers.concatenate([tower_27, tower_28, tower_29, tower_30], axis=1) # (4, 4, 528)
